...
namespace Latihan_async
{
    class Program
    {
        ...
        {
            var Headlines = new GetHeadlines();
            Headlines.Start();
            ...
            /* var deleteJsonResponse = await fetch.Delete("https://httpbin.org/delete");
             ...
             var jsonData = @"
                 ...
                 ";*/
           /* var postJsonResponse = await fetch.Posts("https://httpbin.org/post");
            var putJsonResponse = await fetch.Put("https://httpbin.org/put");
            var patchJsonResponse = await fetch.Patch("https://httpbin.org/put");
*/
